<?php 
     // veritabanı bağlantısı 
          ...
          // tablolardan verileri çekiyoruz
            $veri = $conn
            ->query("SELECT baslik, icerik FROM hakkimizda WHERE id = 1")
            ->fetchAll();
            $sub = $conn
            ->query("SELECT baslik, icerik FROM hakkimzdasub WHERE id = 1")
            ->fetchAll();
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto align-self-center">
            <div class=" text-center">
              <!-- ekrana tablodaki verileri yazdırıyoruz -->
              <h1><?php echo $veri[0][0];?></h1>
              <p><?php echo $veri[0][1];?></p>ˀ
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black"><?php echo $sub[0][0];?></h2>
            </div>
            <p><?php echo $sub[0][1];?></p>
