                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active " href="add_users.php">
        ...
        <div class="row">
            <div class="col-12 col-xl-12">
                <div class="card card-body border-0 shadow mb-4">
                    <h2 class="h5 mb-4">Kullanıcı Ekle</h2>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label for="urun-adi">Kullanıcı Adı</label>
                                    <input class="form-control" name="username" id="urunadi" type="text"
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 mb-3">
                                <label for="urun-fiyat">Şifre</label>
                                <div class="input-group">
                                    </span>
                                    <input class="form-control" name="password" id="urun-fiyat" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="stok">Mail</label>
                                <input class="form-control" id="stok" name="mail" type="text" placeholder="mail"
                                    required>
                            </div>
                        </div>
                </div>
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        <input class="form-control btn-outline-indigo btn btn-success" name="submit" type="submit"
                            placeholder="50" required style="width: 200px; color:white " value="Kullanıcıyı Ekle">
                    </div>
                </div>
                ...
                <?php
                // kullanıcı ekle butonunun fonksiyonu
