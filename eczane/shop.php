...
?>
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        <!-- tablodaki verileri yazdırıyoruz -->
                        <a href="#"> <img src="admin/assets/images/gallery/uploads/<?php echo $value['img']?>" alt="Image"></a>
                        <h3 class="text-dark"><a href="#"><?php echo $value['name']?></a></h3>
